    ...
    cuestionario: {
      ...
      preguntas: [
        ...
        },
        {
          id: 7,
          texto:
            '<em>Desmanche</em> es una técnica que consiste en extraer todos los colinos que surgieron de la planta madre porque afectan su desarrollo debido a la competencia de luz, agua y nutrientes',
